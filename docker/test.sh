...
docker volume create fetalheadsegalgorithm-output-$VOLUME_SUFFIX
...
docker run --rm \
        ...
        -v fetalheadsegalgorithm-output-$VOLUME_SUFFIX:/output/ \
        fetalheadsegalgorithm
...
docker volume rm fetalheadsegalgorithm-output-$VOLUME_SUFFIX
